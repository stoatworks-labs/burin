/*
 * Stoatworks Labs - About window data for Burin.
 *
...
{
    inline constexpr auto name = "Burin";
    inline constexpr auto slug = "burin";
    inline constexpr auto hook = "Draw vector artwork in Resolume, at any size";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/burin/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/burin/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/burin";
