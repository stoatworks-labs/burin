...
**[v0.1.5](https://github.com/stoatworks-labs/burin/releases/tag/v0.1.5)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`burin-0.1.5-macos-universal.dmg`](https://github.com/stoatworks-labs/burin/releases/download/v0.1.5/burin-0.1.5-macos-universal.dmg) | 638 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`burin-0.1.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/burin/releases/download/v0.1.5/burin-0.1.5-windows-x86_64-setup.exe) | 274 KB |
