...
**[v0.1.6](https://github.com/stoatworks-labs/burin/releases/tag/v0.1.6)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`burin-0.1.6-macos-universal.dmg`](https://github.com/stoatworks-labs/burin/releases/download/v0.1.6/burin-0.1.6-macos-universal.dmg) | 638 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`burin-0.1.6-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/burin/releases/download/v0.1.6/burin-0.1.6-windows-x86_64-setup.exe) | 274 KB |
